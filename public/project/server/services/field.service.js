...
module.exports = function (app, model) {
    app.post('/api/project/form/:formId/field', create);
    app.get('/api/project/form/:formId/field', findFieldsByFormId);
    app.get('/api/project/form/:formId/field/:fieldId', findFieldByFormIdFieldId);
    app.put(' /api/project/form/:formId/field/:fieldId', update);
    app.delete('/api/project/form/:formId/field/:fieldId', remove);
